...
import es.unizar.webeng.hello.dictionary.ApiDictionary
...
class ApiDictionaryUnitTest {
    ...
    fun testCorrectSearchTerm() {
        ...
        var message = dictionary.searchDictionary("patata")
    ...
    fun testIncorrectSearchTerm() {
        // Check if the message is correctly translate from Spanish to English
        var message = dictionary.searchDictionary("qtysusiusri6rd")
